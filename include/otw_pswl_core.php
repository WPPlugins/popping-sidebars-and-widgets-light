		...
		if( isset( $attributes['sidebar'] ) ){
			...
			if( is_active_sidebar( $attributes['sidebar'] ) ){
				...
				switch( $widget_alignement ){
					...
					case 'horizontal':
							$container .= ' otw-row';
							global $otw_pswl_grid_manager_object;
							$widget_percentage = 'otw-'.$otw_pswl_grid_manager_object->number_names[ $otw_pswl_grid_manager_object->grid_size / count( $sidebars_widgets[$index] ) ];
