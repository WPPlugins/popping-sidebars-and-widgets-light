<?php
class OTW_Overlay_Shortcode extends OTW_Component{
	...
	public function include_shortcodes(){
		...
		foreach( $this->shortcodes as $shortcode_key => $shortcode_settings ){
			...
			if( !is_array( $shortcode_settings['children'] ) || !count( $shortcode_settings['children'] ) ){
				...
				if( !class_exists( 'OTW_Overlay_ShortCode_'.$shortcode_key ) ){
				...
				$class_name = 'OTW_Overlay_ShortCode_'.$otw_shortcode_key;
	...
	public function load_admin_js(){
		...
		$js .= "otw_overlay_shortcode_component = new otw_shortcode_object();";
		$js .= "otw_overlay_shortcode_component.shortcodes = ".$this->format_js_shortcodes().";";
		$js .= "otw_overlay_shortcode_component.labels = ".json_encode( $this->labels ).";";
		$js .= "otw_overlay_shortcode_component.tinymce_button_key='".$this->tinymce_button_key."';";
		$js .= "otw_overlay_shortcode_component.wp_url='admin-ajax'";
		$js .= "</script>";
	...
	public function load_front_js(){
		...
		$js .= "otw_overlay_shortcode_component.labels = ".json_encode( $this->labels ).";";
		$js .= "otw_overlay_shortcode_component.tinymce_button_key='".$this->tinymce_button_key."';";
		$js .= "otw_overlay_shortcode_component.wp_url='".get_site_url()."/wp-admin/admin-ajax'";
		$js .= "</script>";
