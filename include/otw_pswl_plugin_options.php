...
$message = '';
$massages = array();
$messages[1] = __( 'Options saved', 'otw_pswl' );
...
<div class="wrap">
	...
	<h2>
		<?php _e('Plugin Options', 'otw_pswl') ?>
	</h2>
			...
			<div id="post-body">
				<div id="post-body-content">
					<div class="form-field">
						<label for="otw_psw_promotions"><?php _e('Show OTW Promotion Messages in my WordPress admin', 'otw_pswl'); ?></label>
					...
					<p class="submit">
						<input type="submit" value="<?php _e( 'Save Options', 'otw_pswl') ?>" name="submit" class="button button-primary button-hero"/>
					</p>
				</div>
			</div>
		</form>
